    ...
    <div class="py-20 px-12 grid grid-cols-2 gap-10">
      ...
      <div class="rounded-md p-4 gradient-border shadow-lightBox dark:shadow-darkBox">
        <div class="mb-4">
          ...
          <ul class="list-inside list-disc pt-1 pl-2 text-gray-300">
            <li>
              <a class="text-primary hover:underline" href="https://github.com/windicss/nuxt-windicss"
                target="_blank">nuxt-windicss</a>
            </li>
            <li>
              <a class="text-primary hover:underline" href="https://github.com/antfu/unplugin-icons"
                target="_blank">unplugin-icons</a>
            </li>
            <li>
              <a class="text-primary hover:underline" href="https://pinia.esm.dev/ssr/nuxt.html"
                target="_blank">@pinia/nuxt</a>
            </li>
            <li>
              <a class="text-primary hover:underline" href="https://github.com/intlify/nuxt3"
                target="_blank">@intlify/nuxt3</a>
            </li>
            <li>
              <a class="text-primary hover:underline" href="https://vueuse.org/nuxt/readme.html#vueuse-nuxt"
                target="_blank">@vueuse/nuxt3</a>
            </li>
          </ul>
        </div>
      </div>
      ...
      <div class="rounded-md p-4 gradient-border shadow-lightBox dark:shadow-darkBox">
        <div class="mb-4 flex flex-col gap-6">
          ...
          <button class="text-primary px-2 py-1 focus:outline-transparent rounded-lg border border-[#00DC82]"
      ...
      <div class="rounded-md p-4 gradient-border shadow-lightBox dark:shadow-darkBox">
        <div class="mb-4 flex flex-col gap-6">
          ...
          <h2 class="text-base">
            ...
            <a class="text-primary hover:underline" href="api/hello?name=World" target="_blank">server/api.ts</a>
          </h2>
